...
import { MonthData, TodayData, WeekData, YearData } from "../../components/Data/Data";
  ...
  return (
    <div className="body d-flex py-3">
      <div className="container-xxl">
        ...
        <div className="mt-1">
          <Tab.Container id="left-tabs-example" defaultActiveKey="today" className="col-lg-12 col-md-12">
            <Row>
              <Col sm={12}>
                            ...
                            <div className="card">
                              <div className="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                <div className="left-info">
                                  ...
                                  <div>
                                    <span className="fs-6 fw-bold me-2">{d.value}</span>
                                  </div>
                                </div>
